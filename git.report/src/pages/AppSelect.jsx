...
export default function AppSelect({ user, onLogout }) {
    ...
    const needsPersonalReport = useMemo(() => {
        ...
        // 만약 이번 주 보고서가 아예 없거나(myData가 없음),
        // 보고서가 있어도 개인보고(isPersonalReported)를 안 했으면 true
        return !myData || !myData.isPersonalReported;
    }, [report, groupId, memberKey]);
        ...
        <div style={{ minHeight: '100vh', background: '#F5F5F7', padding: '40px 20px 80px' }}>
            <div className="container animate-fade-in" style={{ maxWidth: 1000 }}>
                ...
                <header style={{
                    ...
                    <div>
                        <div style={{ fontSize: 16, color: '#1D1D1F', fontWeight: 600, marginBottom: 4 }}>
                            안녕하세요, 마산회원교회
                        </div>
                        <h2 className="title-large" style={{ margin: 0, lineHeight: 1.2 }}>
                            <span style={{ color: '#0071E3' }}>{user.name}</span> 님
                        </h2>
                    </div>
                    <button
                        onClick={onLogout}
                ...
                <div style={{
                    ...
                    {/* Personal Devotion App - First Card */}
                    <div
                    ...
                    >
                        ...
                        <h3 className="title-medium" style={{ margin: 0, fontSize: 17, fontWeight: 800, letterSpacing: '-0.5px', wordBreak: 'keep-all' }}>개인경건보고</h3>
                        <p style={{ margin: '4px 0 0 0', fontSize: 11, color: '#86868B', textAlign: 'center', letterSpacing: '-0.3px', wordBreak: 'keep-all', fontWeight: 500, lineHeight: 1.3 }}>
                            당신의 귀한 삶을<br />목자에게 알려주세요
                        </p>
                    </div>

                    {/* Prayer Scent App - Second Card */}
                    <div
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            <img src="/icons/fire.png" alt="기도의 향" style={{ width: 32, height: 32, objectFit: 'contain' }} onError={(e) => { e.target.style.display = 'none'; e.target.nextSibling.style.display = 'block'; }} />
                            <span style={{ fontSize: 36, display: 'none' }}>🔥</span>
                        </div>
                        <h3 className="title-medium" style={{ margin: 0, fontSize: 17, fontWeight: 800, letterSpacing: '-0.5px', wordBreak: 'keep-all' }}>기도의 향</h3>
                    </div>

                    {/* Bible Crew App - Third Card (Updated Color) */}
                    <div
                        className="apple-card"
                        style={{
                            cursor: 'default',
                    ...
                    >
                        ...
                        <h3 className="title-medium" style={{ margin: 0, fontSize: 17, fontWeight: 800, letterSpacing: '-0.5px', wordBreak: 'keep-all' }}>성경러닝크루</h3>
                    </div>

                    {/* Ranch Report App - Fourth Card (Updated Color) */}
                    <div
                    ...
                    >
                        ...
                        <h3 className="title-medium" style={{ margin: 0, fontSize: 17, fontWeight: 800, letterSpacing: '-0.5px', wordBreak: 'keep-all' }}>목자보고</h3>
                    </div>
                </div>
            </div>
